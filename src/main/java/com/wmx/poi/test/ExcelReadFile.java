...
public class ExcelReadFile {
     ...
     * see {@link ExcelReadFile#testCreateSampleSheet(String)}.<br>
     *
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 2) {
            ...
            try (HSSFWorkbook wb = ExcelReadFile.readFile(fileName)) {
            ...
            if ("write".equalsIgnoreCase(args[1])) {
                ...
                ExcelReadFile.testCreateSampleSheet(fileName);
